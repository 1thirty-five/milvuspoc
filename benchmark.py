...
Run:
    python benchmark.py                 # benchmark the default model (minilm)
...
def main(model_name=DEFAULT_MODEL):
    ...
    model_id = resolve_model(model_name)[0]
...
**Setup:** model `{model_id}`, {n} base documents from `{DEFAULT_INPUT}`,
